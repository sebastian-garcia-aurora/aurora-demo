...
6. If approved:
   ...
   b. Create a new QA ticket as a subtask: POST /api/companies/{companyId}/issues with parentId assign to @qa agent.
   c. In the qa ticket description include: PR URL, branch name, what was changed, what to test. IMPORTANT: DO NOT TAG THE QA AGENT IN A COMMENT OR TICKET DESCRIPTION, YOU ARE ALREADY ASSIGNING QA TO THE TICKET
