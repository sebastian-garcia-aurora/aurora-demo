...
2. You MUST follow the `coding-workflow` skill regarding coding, commits and testing. Work on the EXISTING branch — do NOT create a new branch
...
5. If tests fail on existing code (not your tests), comment on the ticket describing the failures, tag the @tech-lead agent and set status to blocked.
6. If all tests pass:
